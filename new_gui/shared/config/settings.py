...
RE_ALL_RELATED = re.compile(r'set\s+ALL_RELATED_(\w+)\s*=\s*"([^"]*)"\s*"([^"]*)"')
...
THEMES = {
    ...
    "dark": {
        ...
        "agent_user_bubble": "#37475a",
        "agent_user_border": "#5081b4",
        "agent_agent_bubble": "#262d36",
        "agent_agent_border": "#3a4452",
        "agent_hint_bg": "#3a3322",
        "agent_hint_border": "#7a6939",
    ...
    "high_contrast": {
        ...
        "agent_user_bubble": "#ffff00",
        "agent_user_border": "#000000",
        "agent_agent_bubble": "#ffffff",
        "agent_agent_border": "#000000",
        "agent_hint_bg": "#ffffff",
        "agent_hint_border": "#000000",
...
STATUS_SNAPSHOT_POLL_INTERVAL_MS = 1000
