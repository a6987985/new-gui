...
from new_gui.infrastructure.repositories.run_dependency import parse_dependency_file
...
def build_action_request(
    ...
    return {
        ...
        "run_sync": run_sync,
        "timeout": timeout,
        "detached": action in LONG_RUNNING_ACTIONS,
    }
...
def execute_shell_command_detached(argv: Sequence[str], cwd: str) -> ActionResult:
    """Spawn a command and return immediately without waiting for completion."""
    try:
        process = subprocess.Popen(
            list(argv),
