...
`new_gui/main.py` as the application entry and MainWindow orchestration layer.
...
| Item | Value |
|---|---:|
| `new_gui/main.py` lines | 1576 |
| `MainWindow` methods | 182 |
| `run_repository.py` lines | 55 |
| Service modules | 28 |
| Extracted widget modules | 15 |
| Extracted dialog modules | 8 |
...
The following are already moved out of `main.py` and are stable:
...
- keep `new_gui/main.py` as the stable entry and orchestration layer
