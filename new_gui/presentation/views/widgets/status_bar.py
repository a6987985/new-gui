...
from new_gui.shared.config.settings import STATUS_CONFIG, THEMES
from new_gui.presentation.styles.status_bar_styles import (
...
from new_gui.presentation.views.widgets.labels import StatusBadgeLabel
